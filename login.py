...
Database.initialise(user='postgres', password='Pa5z', host='localhost', database='learning')
...
tweets = user.twitter_request('https://api.twitter.com/1.1/search/tweets.json?computers+filter:images')
